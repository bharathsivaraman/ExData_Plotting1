...
power_consum$global_reactive_power<-as.numeric(power_consum$global_reactive_power)
...
with(power_consum,plot(datetime,global_active_power,type="l",xlab="",ylab = "Global Active Power"))

with(power_consum,plot(datetime,voltage,type="l"))
...
legend("topright",c("sub_metering_!","sub_metering_2","sub_metering_3"),lty=1,col=c("black","red","blue"),cex=.75)
title(main="Plot3",xlab="",ylab="Energy sub metering")

with(power_consum,plot(datetime,global_reactive_power,type="l"))
